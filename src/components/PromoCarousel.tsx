  ...
  return (
    ...
    >
      <div className="promo-viewport">
        ...
        {count > 1 && (
          <>
            <button className="promo-arrow promo-arrow-prev" onClick={() => go(index - 1)} aria-label="Previous promotion">
              <ChevronIcon dir="left" />
            </button>
            <button className="promo-arrow promo-arrow-next" onClick={() => go(index + 1)} aria-label="Next promotion">
