          ...
          {tiles.map(({ letter, name, imageUrl, href }, i) => (
            <div key={name} className="flip-card" style={{ aspectRatio: '1', cursor: 'pointer' }}>
              <div className="flip-card-inner">
                <Link to={href} className="flip-card-front" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-end', padding: '1.5rem 1rem 1.625rem', backgroundColor: catBgs[i], border: '1px solid rgba(43,35,32,0.07)', textDecorationLine: 'none' }}>
                ...
                <Link to={href} className="flip-card-back" style={{ display: 'block', textDecorationLine: 'none', overflow: 'hidden' }}>
